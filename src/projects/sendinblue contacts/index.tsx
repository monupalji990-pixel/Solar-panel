...
function DashboardRoutes(props) {
  useInjectReducer({ key: sliceKeyTemplate, reducer: templateReducer });
  useInjectSaga({ key: sliceKeyTemplate, saga: templateSaga });
    ...
    <>
      <main className={classes.drawerClose} id="headerSpace">
        ...
        <Switch>
          ...
          <Route
            exact
            path="/sendinblue/management/view"
            render={(route) => (
              <Common
                {...route}
                slug="management"
