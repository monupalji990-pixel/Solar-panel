...
function RecordsRoutes(props) {
  useInjectReducer({ key: sliceKeyRecord, reducer: recordReducer });
  useInjectSaga({ key: sliceKeyRecord, saga: recordSaga });
