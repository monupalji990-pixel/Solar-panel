...
export default function InstallerCompanyDocument(props) {
    ...
    const documents = props.currentCompany.installerDocuments ? [...props.currentCompany.installerDocuments]: []
                            ...
                            return (
                                <form onSubmit={handleSubmit}>
                                    ...
                                    >
                                        ...
                                        >
                                            Add Document </Button> {currentProps.isAddDocumentLoading && <CircularProgress />}
                                    </CardActions>
                                </form>
                            );
                        }}
