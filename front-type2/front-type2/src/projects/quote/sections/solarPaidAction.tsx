    ...
    const statusFilter = () => {
        ...
        switch (quoteStatus) {
            ...
            case 1027:
                ...
                break;
            case 1031:
                if (props.currentQuote?.service?.paidsolar?.dnoApproval == 'Yes') {
                    setStatus([
                        {
        ...
        <React.Fragment>
            <Grid container spacing={3} className={classes.PaddingSpace}>
                <Grid item xs={12} md={12}>
                    {[1000, 1027, 1019, 1021].includes(props.currentQuote.quoteStatus) &&
                        <Button
                            size="medium"
                            variant="contained"
                            color="primary"
                        ...
                        <Formik
                            ...
                            onSubmit={(value) => {
                                try {
                                    ...
                                    props._quoteActions(negotiation, 'paidsolar');
                                } catch (error) {
