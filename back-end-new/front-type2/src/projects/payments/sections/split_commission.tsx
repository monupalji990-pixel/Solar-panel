...
export default function SplitCommissions(props) {
                ...
                <Formik
                    ...
                    onSubmit={(values) => {
                        try {
                            const obj: any = {}
                            const search: any = {}
                            if (values.startDate) search.startDate = values.startDate
                            if (values.endDate) search.endDate = values.endDate
                            if (values.user) {
                                obj.user = values.user.value
                            }
                            else {
                                obj.user = "All"
                            }
