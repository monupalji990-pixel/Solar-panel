...
export default function ViewAppointment(props) {
  ...
  return (
    <MyDrawer
      ...
      open={props.open === "viewAppointmentDrawer" ? true : false}
      onClose={props.onClose.bind(this)}
    >
      <ViewAppointmentLogic {...props} />
    </MyDrawer>
  );
}

function ViewAppointmentLogic(props) {
  ...
  const [CreateRadioToggle, setCreateRadioToggle] = useState('');
  ...
  useEffect(() => {
    setCreateRadioToggle(props.viewAppointment?.Consumer?._id ? 'Consumer' : 'Company')
  }, [props.viewAppointment?.Consumer?._id])
      ...
      <Formik
        ...
        onSubmit={(value) => {
          try {
            ...
            console.error("Error while add appointment: ", error)
          }
        }}
          ...
          return (
            <form onSubmit={handleSubmit}>
              <Grid container spacing={3}>
                        ...
                        {Company?.businessName && (
                          <React.Fragment>
                            <TableRow>
                              ...
                              <TableCell component="th" scope="row">
                                <span style={{ cursor: 'pointer', textDecoration: 'underline' }} onClick={() => viewCompany(Company)}>
                                  {Company?.businessName}
                                </span>
                              </TableCell>
                            </TableRow>
                        ...
                        {Consumer?.firstName && (
                          <React.Fragment>
                            <TableRow>
                              ...
                              <TableCell component="th" scope="row">
                                <span style={{ cursor: 'pointer', textDecoration: 'underline' }} onClick={() => viewConsumer(Consumer)}>
                ...
                {/* 
                <Grid item xs={12} md={12}>
                  <label style={{ paddingBottom: 10, display: 'block' }}>Lead Administrator</label>
                  <Select
                    className={
